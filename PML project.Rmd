...
```
## Now, lets clean the data up a bit:
...
## partitioning the data
 ...
 I've partition the processes pmltraining data into 3/4 training and 1/4 testing for the cross validation - to understand the out of sample error rate and see that the model doesn't overfitt. 
